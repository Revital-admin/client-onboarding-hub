    ...
    filteredItems.forEach(item => {
      ...
      card.innerHTML = `
        ...
        <div class="checklist-item-content">
          ...
          <div class="checklist-item-notes-wrap">
            <textarea class="checklist-item-notes" placeholder="Add notes..." rows="1">${item.notes || ""}</textarea>
          </div>
        </div>
      `;
      ...
      const notesArea = card.querySelector(".checklist-item-notes");
