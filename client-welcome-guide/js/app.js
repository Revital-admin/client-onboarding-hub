document.addEventListener('DOMContentLoaded', () => {
  ...
  generateBtn.addEventListener('click', () => {
    ...
    // exactly 2 real pages (the page-1 and page-2 divs) - if jsPDF
    // produced more, the earlier ones are always blank, so trim from the
    // front until exactly 2 pages remain.
